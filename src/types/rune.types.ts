...
/**
 * Represents the validation result of a Rune transaction
 */
...
/**
 * Represents metadata for a specific Rune
 */
...
/**
 * Represents the sync status with Ord node
 */
export interface OrdSyncStatus {
